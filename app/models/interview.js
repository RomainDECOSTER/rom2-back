...
const InterviewSchema = new MongooseSchema(
  {
    interviewed_id: { type: mongoose.Schema.Types.ObjectId, ref: 'Volunteer' || 'Student', required: true },
    interviewed_type: { type: String, enum: ['volunteer', 'student'] },
    user: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
    campaign: { type: mongoose.Schema.Types.ObjectId, ref: 'Campaign' },
    interviewed_classmate_id: { type: mongoose.Schema.Types.ObjectId, ref: 'Volunteer' || 'Student', required: true },
